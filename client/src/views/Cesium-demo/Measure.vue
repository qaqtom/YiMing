<template>
    ...
    <div class="measureContainer">
        <Panel size="medium" title="测量">
            <div class="content">
                <div class="list">
                    <div class="item">
                        <div class="index">1</div>
                        <div class="name">空间距离</div>
                        <el-switch v-model="distance" @change="updateDistance" />
                    </div>
                </div>
                <div class="list">
                    <div class="item">
                        ...
                        <el-switch v-model="area" @change="updateArea" />
                    </div>
                </div>
            </div>
        </Panel>
...
const { data } = measureStore
let { viewer } = storeToRefs(viewerStore)
let distance = ref(data[0].value)
let area = ref(data[1].value)
...
const updateDistance = (e: boolean | string | number) => {
    ...
    area.value = false
    measureStore.updateDistance(e as boolean)
}

const updateArea = (e: boolean | string | number) => {
    measureStore.updateDistance(false)
    distance.value = false
    measureStore.updateArea(e as boolean)
}
