...
CREATE TABLE `dlxxxtyl`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '地理信息系统原理' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `hjcz`  (
  ...
  `spirit` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '精神',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '红军长征' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `ldr`  (
  ...
  `spirit` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '精神',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '李德仁' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `pyfa`  (
  ...
  `course_url` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '跳转链接',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 130 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '培养方案' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of pyfa
-- ----------------------------
INSERT INTO `pyfa` VALUES (1, '海洋类', '海洋科学导论', 'https://geo.jlu.edu.cn/info/1414/2955.htm');
INSERT INTO `pyfa` VALUES (2, '海洋类', '物理海洋学基础', 'https://www.icourse163.org/course/ZJU-1206693838?tid=1473273453');
INSERT INTO `pyfa` VALUES (3, '测绘工程', '数字地形测量学', 'https://www.icourse163.org/course/WHU-1205724809?from=searchPage');
INSERT INTO `pyfa` VALUES (4, '测绘工程', '地理信息系统原理', 'https://www.osgeo.cn/gis-tutorial/');
INSERT INTO `pyfa` VALUES (5, '测绘工程', '遥感原理与应用', 'https://www.icourses.cn/sCourse/course_6862.html');
INSERT INTO `pyfa` VALUES (6, '测绘工程', '数字图像处理', 'https://www.icourse163.org/course/SJTU-1003381021');
INSERT INTO `pyfa` VALUES (7, '测绘工程', '误差理论与测量平差', 'https://next.xuetangx.com/course/XUST08121001539/1300592');
INSERT INTO `pyfa` VALUES (8, '测绘工程', '卫星定位原理及应用', 'http://pt.csust.edu.cn/meol/jpk/course/layout/newpage/index.jsp?courseId=43679');
INSERT INTO `pyfa` VALUES (9, '测绘工程', '摄影测量学基础', 'https://higher.smartedu.cn/course/649e0a0dd190d2a6beeee280');
INSERT INTO `pyfa` VALUES (10, '测绘工程', '物理大地测量学', 'https://www.icourses.cn/sCourse/course_6646.html');
INSERT INTO `pyfa` VALUES (11, '测绘工程', '大地测量学基础', 'https://www.icourse163.org/course/WHU-1464124180?from=searchPage');
INSERT INTO `pyfa` VALUES (12, '测绘工程', '地图学基础', NULL);
INSERT INTO `pyfa` VALUES (13, '测绘工程', '工程测量学', NULL);
INSERT INTO `pyfa` VALUES (14, '地理信息科学', '地图学基础', NULL);
INSERT INTO `pyfa` VALUES (15, '地理信息科学', '遥感原理与应用', NULL);
INSERT INTO `pyfa` VALUES (16, '地理信息科学', '数字地形测量学', NULL);
INSERT INTO `pyfa` VALUES (17, '地理信息科学', '摄影测量学基础', NULL);
INSERT INTO `pyfa` VALUES (18, '地理信息科学', '地理信息系统原理', NULL);
INSERT INTO `pyfa` VALUES (19, '地理信息科学', 'GIS 应用开发', NULL);
INSERT INTO `pyfa` VALUES (20, '地理信息科学', '空间数据库', NULL);
INSERT INTO `pyfa` VALUES (21, '地理信息科学', 'GIS 空间分析', NULL);
INSERT INTO `pyfa` VALUES (22, '地理信息科学', '卫星定位原理及应用', NULL);
INSERT INTO `pyfa` VALUES (23, '地理信息科学', '自然地理学', NULL);
INSERT INTO `pyfa` VALUES (24, '电子信息工程', '信号与系统', NULL);
INSERT INTO `pyfa` VALUES (25, '电子信息工程', '人工智能模型和算法', NULL);
INSERT INTO `pyfa` VALUES (26, '电子信息工程', '模拟电子技术', NULL);
INSERT INTO `pyfa` VALUES (27, '电子信息工程', '海洋信息技术基础', NULL);
INSERT INTO `pyfa` VALUES (28, '电子信息工程', '微机原理', NULL);
INSERT INTO `pyfa` VALUES (29, '电子信息工程', '电子信息系统设计', NULL);
INSERT INTO `pyfa` VALUES (30, '电子信息工程', '数字电子技术', NULL);
INSERT INTO `pyfa` VALUES (31, '电子信息工程', '通信原理', NULL);
INSERT INTO `pyfa` VALUES (32, '电子信息工程', '数字信号处理', NULL);
INSERT INTO `pyfa` VALUES (33, '电子信息工程', '电路理论基础', NULL);
INSERT INTO `pyfa` VALUES (34, '电子信息工程', '电磁场与电磁波', NULL);
INSERT INTO `pyfa` VALUES (35, '通信工程', '数据结构与算法', NULL);
INSERT INTO `pyfa` VALUES (36, '通信工程', '通信原理', NULL);
INSERT INTO `pyfa` VALUES (37, '通信工程', '信息论与编码', NULL);
INSERT INTO `pyfa` VALUES (38, '通信工程', '模拟电子技术', NULL);
INSERT INTO `pyfa` VALUES (39, '通信工程', '信号与系统', NULL);
INSERT INTO `pyfa` VALUES (40, '通信工程', '通信电子线路', NULL);
INSERT INTO `pyfa` VALUES (41, '通信工程', '通信工程概论', NULL);
INSERT INTO `pyfa` VALUES (42, '通信工程', '数字系统设计', NULL);
INSERT INTO `pyfa` VALUES (43, '通信工程', '计算机网络', NULL);
INSERT INTO `pyfa` VALUES (44, '通信工程', '数字信号处理', NULL);
INSERT INTO `pyfa` VALUES (45, '通信工程', '电路理论基础', NULL);
INSERT INTO `pyfa` VALUES (46, '通信工程', '电磁场与电磁波', NULL);
INSERT INTO `pyfa` VALUES (129, '海洋类', '这是一个测试案例', NULL);
...
INSERT INTO `users` VALUES (3, 'qymtest', '$2b$10$v8XSzaB2SAUKRrjB66gJ6O0LuyU6s2h7XVAVxVIjOTu5sq5euxb.y', 'admin', '8888', '2024-09-07 15:32:43');
